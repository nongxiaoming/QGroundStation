...
AccessoryDesired::AccessoryDesired(): UAVDataObject(OBJID, ISSINGLEINST, ISSETTINGS, NAME)
{
    ...
    AccessoryValElemNames.append("0");
    fields.append( new UAVObjectField(QString("AccessoryVal"), QString(""), UAVObjectField::FLOAT32, AccessoryValElemNames, QStringList(), QString("")));
