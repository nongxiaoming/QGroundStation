...
class UAVOBJECTS_EXPORT StabilizationBank: public UAVDataObject
{
    Q_OBJECT
...
public:
    ...
    // Constants
    static const quint32 OBJID = 0x496BCEA8;
    ...
    static StabilizationBank* GetInstance(UAVObjectManager* objMngr, quint32 instID = 0);
