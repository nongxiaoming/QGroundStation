...
{
    Q_OBJECT
    Q_PROPERTY(quint8 LogOn READ getLogOn WRITE setLogOn NOTIFY LogOnChanged);
...
public:
    ...
    Q_INVOKABLE quint8 getLogOn() const;


public slots:
    void setLogOn(quint8 value);


signals:
    void LogOnChanged(quint8 value);
