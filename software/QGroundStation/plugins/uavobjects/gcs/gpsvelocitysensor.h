...
class UAVOBJECTS_EXPORT GPSVelocitySensor: public UAVDataObject
{
    Q_OBJECT
...
public:
    ...
    // Constants
    static const quint32 OBJID = 0xBC57454;
    ...
    static GPSVelocitySensor* GetInstance(UAVObjectManager* objMngr, quint32 instID = 0);
