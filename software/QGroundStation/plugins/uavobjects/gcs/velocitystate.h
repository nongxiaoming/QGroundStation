...
class UAVOBJECTS_EXPORT VelocityState: public UAVDataObject
{
    Q_OBJECT
...
public:
    ...
    // Constants
    static const quint32 OBJID = 0xC243686C;
    ...
    static VelocityState* GetInstance(UAVObjectManager* objMngr, quint32 instID = 0);
