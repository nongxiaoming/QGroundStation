...
class UAVOBJECTS_EXPORT StabilizationSettingsBank2: public UAVDataObject
{
    Q_OBJECT
...
public:
    ...
    // Constants
    static const quint32 OBJID = 0xF726554;
    ...
    static StabilizationSettingsBank2* GetInstance(UAVObjectManager* objMngr, quint32 instID = 0);
