 ...
 */
void StabilizationSettingsBank2::setData(const DataFields& data)
{
    QMutexLocker locker(mutex);
    // Get metadata
...
float StabilizationSettingsBank2::getManualRate(quint32 index) const
{
   QMutexLocker locker(mutex);
   return data.ManualRate[index];
}
void StabilizationSettingsBank2::setManualRate(quint32 index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getManualRate_Roll() const
{
   QMutexLocker locker(mutex);
   return data.ManualRate[0];
}
void StabilizationSettingsBank2::setManualRate_Roll(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getManualRate_Pitch() const
{
   QMutexLocker locker(mutex);
   return data.ManualRate[1];
}
void StabilizationSettingsBank2::setManualRate_Pitch(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getManualRate_Yaw() const
{
   QMutexLocker locker(mutex);
   return data.ManualRate[2];
}
void StabilizationSettingsBank2::setManualRate_Yaw(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getMaximumRate(quint32 index) const
{
   QMutexLocker locker(mutex);
   return data.MaximumRate[index];
}
void StabilizationSettingsBank2::setMaximumRate(quint32 index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getMaximumRate_Roll() const
{
   QMutexLocker locker(mutex);
   return data.MaximumRate[0];
}
void StabilizationSettingsBank2::setMaximumRate_Roll(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getMaximumRate_Pitch() const
{
   QMutexLocker locker(mutex);
   return data.MaximumRate[1];
}
void StabilizationSettingsBank2::setMaximumRate_Pitch(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getMaximumRate_Yaw() const
{
   QMutexLocker locker(mutex);
   return data.MaximumRate[2];
}
void StabilizationSettingsBank2::setMaximumRate_Yaw(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getRollRatePID(quint32 index) const
{
   QMutexLocker locker(mutex);
   return data.RollRatePID[index];
}
void StabilizationSettingsBank2::setRollRatePID(quint32 index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getRollRatePID_Kp() const
{
   QMutexLocker locker(mutex);
   return data.RollRatePID[0];
}
void StabilizationSettingsBank2::setRollRatePID_Kp(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getRollRatePID_Ki() const
{
   QMutexLocker locker(mutex);
   return data.RollRatePID[1];
}
void StabilizationSettingsBank2::setRollRatePID_Ki(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getRollRatePID_Kd() const
{
   QMutexLocker locker(mutex);
   return data.RollRatePID[2];
}
void StabilizationSettingsBank2::setRollRatePID_Kd(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getRollRatePID_ILimit() const
{
   QMutexLocker locker(mutex);
   return data.RollRatePID[3];
}
void StabilizationSettingsBank2::setRollRatePID_ILimit(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getPitchRatePID(quint32 index) const
{
   QMutexLocker locker(mutex);
   return data.PitchRatePID[index];
}
void StabilizationSettingsBank2::setPitchRatePID(quint32 index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getPitchRatePID_Kp() const
{
   QMutexLocker locker(mutex);
   return data.PitchRatePID[0];
}
void StabilizationSettingsBank2::setPitchRatePID_Kp(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getPitchRatePID_Ki() const
{
   QMutexLocker locker(mutex);
   return data.PitchRatePID[1];
}
void StabilizationSettingsBank2::setPitchRatePID_Ki(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getPitchRatePID_Kd() const
{
   QMutexLocker locker(mutex);
   return data.PitchRatePID[2];
}
void StabilizationSettingsBank2::setPitchRatePID_Kd(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getPitchRatePID_ILimit() const
{
   QMutexLocker locker(mutex);
   return data.PitchRatePID[3];
}
void StabilizationSettingsBank2::setPitchRatePID_ILimit(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getYawRatePID(quint32 index) const
{
   QMutexLocker locker(mutex);
   return data.YawRatePID[index];
}
void StabilizationSettingsBank2::setYawRatePID(quint32 index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getYawRatePID_Kp() const
{
   QMutexLocker locker(mutex);
   return data.YawRatePID[0];
}
void StabilizationSettingsBank2::setYawRatePID_Kp(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getYawRatePID_Ki() const
{
   QMutexLocker locker(mutex);
   return data.YawRatePID[1];
}
void StabilizationSettingsBank2::setYawRatePID_Ki(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getYawRatePID_Kd() const
{
   QMutexLocker locker(mutex);
   return data.YawRatePID[2];
}
void StabilizationSettingsBank2::setYawRatePID_Kd(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getYawRatePID_ILimit() const
{
   QMutexLocker locker(mutex);
   return data.YawRatePID[3];
}
void StabilizationSettingsBank2::setYawRatePID_ILimit(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getRollPI(quint32 index) const
{
   QMutexLocker locker(mutex);
   return data.RollPI[index];
}
void StabilizationSettingsBank2::setRollPI(quint32 index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getRollPI_Kp() const
{
   QMutexLocker locker(mutex);
   return data.RollPI[0];
}
void StabilizationSettingsBank2::setRollPI_Kp(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getRollPI_Ki() const
{
   QMutexLocker locker(mutex);
   return data.RollPI[1];
}
void StabilizationSettingsBank2::setRollPI_Ki(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getRollPI_ILimit() const
{
   QMutexLocker locker(mutex);
   return data.RollPI[2];
}
void StabilizationSettingsBank2::setRollPI_ILimit(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getPitchPI(quint32 index) const
{
   QMutexLocker locker(mutex);
   return data.PitchPI[index];
}
void StabilizationSettingsBank2::setPitchPI(quint32 index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getPitchPI_Kp() const
{
   QMutexLocker locker(mutex);
   return data.PitchPI[0];
}
void StabilizationSettingsBank2::setPitchPI_Kp(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getPitchPI_Ki() const
{
   QMutexLocker locker(mutex);
   return data.PitchPI[1];
}
void StabilizationSettingsBank2::setPitchPI_Ki(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getPitchPI_ILimit() const
{
   QMutexLocker locker(mutex);
   return data.PitchPI[2];
}
void StabilizationSettingsBank2::setPitchPI_ILimit(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getYawPI(quint32 index) const
{
   QMutexLocker locker(mutex);
   return data.YawPI[index];
}
void StabilizationSettingsBank2::setYawPI(quint32 index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getYawPI_Kp() const
{
   QMutexLocker locker(mutex);
   return data.YawPI[0];
}
void StabilizationSettingsBank2::setYawPI_Kp(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getYawPI_Ki() const
{
   QMutexLocker locker(mutex);
   return data.YawPI[1];
}
void StabilizationSettingsBank2::setYawPI_Ki(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank2::getYawPI_ILimit() const
{
   QMutexLocker locker(mutex);
   return data.YawPI[2];
}
void StabilizationSettingsBank2::setYawPI_ILimit(float value)
{
   mutex->lock();
...
quint8 StabilizationSettingsBank2::getRollMax() const
{
   QMutexLocker locker(mutex);
   return data.RollMax;
}
void StabilizationSettingsBank2::setRollMax(quint8 value)
{
   mutex->lock();
...
quint8 StabilizationSettingsBank2::getPitchMax() const
{
   QMutexLocker locker(mutex);
   return data.PitchMax;
}
void StabilizationSettingsBank2::setPitchMax(quint8 value)
{
   mutex->lock();
...
quint8 StabilizationSettingsBank2::getYawMax() const
{
   QMutexLocker locker(mutex);
   return data.YawMax;
}
void StabilizationSettingsBank2::setYawMax(quint8 value)
{
   mutex->lock();
