...
class UAVOBJECTS_EXPORT GyroState: public UAVDataObject
{
    Q_OBJECT
...
public:
    ...
    // Constants
    static const quint32 OBJID = 0x8C2D810A;
    ...
    static GyroState* GetInstance(UAVObjectManager* objMngr, quint32 instID = 0);
