...
float StabilizationSettingsBank3::getManualRate(quint32 index) const
{
   QMutexLocker locker(mutex);
   return data.ManualRate[index];
}
void StabilizationSettingsBank3::setManualRate(quint32 index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getManualRate_Roll() const
{
   QMutexLocker locker(mutex);
   return data.ManualRate[0];
}
void StabilizationSettingsBank3::setManualRate_Roll(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getManualRate_Pitch() const
{
   QMutexLocker locker(mutex);
   return data.ManualRate[1];
}
void StabilizationSettingsBank3::setManualRate_Pitch(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getManualRate_Yaw() const
{
   QMutexLocker locker(mutex);
   return data.ManualRate[2];
}
void StabilizationSettingsBank3::setManualRate_Yaw(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getMaximumRate(quint32 index) const
{
   QMutexLocker locker(mutex);
   return data.MaximumRate[index];
}
void StabilizationSettingsBank3::setMaximumRate(quint32 index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getMaximumRate_Roll() const
{
   QMutexLocker locker(mutex);
   return data.MaximumRate[0];
}
void StabilizationSettingsBank3::setMaximumRate_Roll(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getMaximumRate_Pitch() const
{
   QMutexLocker locker(mutex);
   return data.MaximumRate[1];
}
void StabilizationSettingsBank3::setMaximumRate_Pitch(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getMaximumRate_Yaw() const
{
   QMutexLocker locker(mutex);
   return data.MaximumRate[2];
}
void StabilizationSettingsBank3::setMaximumRate_Yaw(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getRollRatePID(quint32 index) const
{
   QMutexLocker locker(mutex);
   return data.RollRatePID[index];
}
void StabilizationSettingsBank3::setRollRatePID(quint32 index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getRollRatePID_Kp() const
{
   QMutexLocker locker(mutex);
   return data.RollRatePID[0];
}
void StabilizationSettingsBank3::setRollRatePID_Kp(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getRollRatePID_Ki() const
{
   QMutexLocker locker(mutex);
   return data.RollRatePID[1];
}
void StabilizationSettingsBank3::setRollRatePID_Ki(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getRollRatePID_Kd() const
{
   QMutexLocker locker(mutex);
   return data.RollRatePID[2];
}
void StabilizationSettingsBank3::setRollRatePID_Kd(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getRollRatePID_ILimit() const
{
   QMutexLocker locker(mutex);
   return data.RollRatePID[3];
}
void StabilizationSettingsBank3::setRollRatePID_ILimit(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getPitchRatePID(quint32 index) const
{
   QMutexLocker locker(mutex);
   return data.PitchRatePID[index];
}
void StabilizationSettingsBank3::setPitchRatePID(quint32 index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getPitchRatePID_Kp() const
{
   QMutexLocker locker(mutex);
   return data.PitchRatePID[0];
}
void StabilizationSettingsBank3::setPitchRatePID_Kp(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getPitchRatePID_Ki() const
{
   QMutexLocker locker(mutex);
   return data.PitchRatePID[1];
}
void StabilizationSettingsBank3::setPitchRatePID_Ki(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getPitchRatePID_Kd() const
{
   QMutexLocker locker(mutex);
   return data.PitchRatePID[2];
}
void StabilizationSettingsBank3::setPitchRatePID_Kd(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getPitchRatePID_ILimit() const
{
   QMutexLocker locker(mutex);
   return data.PitchRatePID[3];
}
void StabilizationSettingsBank3::setPitchRatePID_ILimit(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getYawRatePID(quint32 index) const
{
   QMutexLocker locker(mutex);
   return data.YawRatePID[index];
}
void StabilizationSettingsBank3::setYawRatePID(quint32 index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getYawRatePID_Kp() const
{
   QMutexLocker locker(mutex);
   return data.YawRatePID[0];
}
void StabilizationSettingsBank3::setYawRatePID_Kp(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getYawRatePID_Ki() const
{
   QMutexLocker locker(mutex);
   return data.YawRatePID[1];
}
void StabilizationSettingsBank3::setYawRatePID_Ki(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getYawRatePID_Kd() const
{
   QMutexLocker locker(mutex);
   return data.YawRatePID[2];
}
void StabilizationSettingsBank3::setYawRatePID_Kd(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getYawRatePID_ILimit() const
{
   QMutexLocker locker(mutex);
   return data.YawRatePID[3];
}
void StabilizationSettingsBank3::setYawRatePID_ILimit(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getRollPI(quint32 index) const
{
   QMutexLocker locker(mutex);
   return data.RollPI[index];
}
void StabilizationSettingsBank3::setRollPI(quint32 index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getRollPI_Kp() const
{
   QMutexLocker locker(mutex);
   return data.RollPI[0];
}
void StabilizationSettingsBank3::setRollPI_Kp(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getRollPI_Ki() const
{
   QMutexLocker locker(mutex);
   return data.RollPI[1];
}
void StabilizationSettingsBank3::setRollPI_Ki(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getRollPI_ILimit() const
{
   QMutexLocker locker(mutex);
   return data.RollPI[2];
}
void StabilizationSettingsBank3::setRollPI_ILimit(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getPitchPI(quint32 index) const
{
   QMutexLocker locker(mutex);
   return data.PitchPI[index];
}
void StabilizationSettingsBank3::setPitchPI(quint32 index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getPitchPI_Kp() const
{
   QMutexLocker locker(mutex);
   return data.PitchPI[0];
}
void StabilizationSettingsBank3::setPitchPI_Kp(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getPitchPI_Ki() const
{
   QMutexLocker locker(mutex);
   return data.PitchPI[1];
}
void StabilizationSettingsBank3::setPitchPI_Ki(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getPitchPI_ILimit() const
{
   QMutexLocker locker(mutex);
   return data.PitchPI[2];
}
void StabilizationSettingsBank3::setPitchPI_ILimit(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getYawPI(quint32 index) const
{
   QMutexLocker locker(mutex);
   return data.YawPI[index];
}
void StabilizationSettingsBank3::setYawPI(quint32 index, float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getYawPI_Kp() const
{
   QMutexLocker locker(mutex);
   return data.YawPI[0];
}
void StabilizationSettingsBank3::setYawPI_Kp(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getYawPI_Ki() const
{
   QMutexLocker locker(mutex);
   return data.YawPI[1];
}
void StabilizationSettingsBank3::setYawPI_Ki(float value)
{
   mutex->lock();
...
float StabilizationSettingsBank3::getYawPI_ILimit() const
{
   QMutexLocker locker(mutex);
   return data.YawPI[2];
}
void StabilizationSettingsBank3::setYawPI_ILimit(float value)
{
   mutex->lock();
...
quint8 StabilizationSettingsBank3::getRollMax() const
{
   QMutexLocker locker(mutex);
   return data.RollMax;
}
void StabilizationSettingsBank3::setRollMax(quint8 value)
{
   mutex->lock();
...
quint8 StabilizationSettingsBank3::getPitchMax() const
{
   QMutexLocker locker(mutex);
   return data.PitchMax;
}
void StabilizationSettingsBank3::setPitchMax(quint8 value)
{
   mutex->lock();
...
quint8 StabilizationSettingsBank3::getYawMax() const
{
   QMutexLocker locker(mutex);
   return data.YawMax;
}
void StabilizationSettingsBank3::setYawMax(quint8 value)
{
   mutex->lock();
