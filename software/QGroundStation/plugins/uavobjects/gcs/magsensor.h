...
class UAVOBJECTS_EXPORT MagSensor: public UAVDataObject
{
    Q_OBJECT
...
public:
    ...
    // Constants
    static const quint32 OBJID = 0x4CBEB6B8;
    ...
    static MagSensor* GetInstance(UAVObjectManager* objMngr, quint32 instID = 0);
