...
//日志文件名称
const QLatin1String LOG_FILENAME("QGroundStation.log");
//应用程序名称
const QLatin1String APP_NAME("QGroundStation");
//核心部件名称
const QLatin1String CORE_PLUGIN_NAME("Core");

const QLatin1String SETTINGS_ORG_NAME("QGroundStation");
const QLatin1String SETTINGS_APP_NAME("QGroundStation_config");

//资源文件
#ifdef Q_OS_MAC
const QLatin1String SHARE_PATH("/../Resources");
#else
const QLatin1String SHARE_PATH("/../share/QGroundStation");
#endif
//默认配置文件名称
const char *DEFAULT_CONFIG_FILENAME = "QGroundStation.xml";
...
{
    Q_UNUSED(context);
    QFile file(QDir::tempPath()+"/"+LOG_FILENAME);
